...
<section class="msger">
  ...
  <div v-if="isSomeoneCalling">
   ...
   <form v-if="!isUserNameSet" class="msger-inputarea">
      ...
      <button type="submit" @click="setUsername" class="msger-send-btn">Chat</button>
    </form>
 
      <main v-if="isUserNameSet" class="msger-chat">
      <div class="msg" v-for="msg in messages" :key="msg.id" :class="{ 'left-msg': msg.sender !== username, 'right-msg': msg.sender === username }">
        <div
        class="msg-img"
        ><span>{{getFirstLetter(msg.sender)}}</span></div>

        <div class="msg-bubble">
          <div class="msg-info">
            <div class="msg-info-name">{{ msg.sender }}</div>
            <div class="msg-info-time">{{convertToTime(msg.time)}}</div>
          </div>
    ...
    <form v-if="isUserNameSet" class="msger-inputarea">
      ...
      <button type="submit" @click="sendMessage" :disabled="!message" class="msger-send-btn">Send</button>
    </form>
